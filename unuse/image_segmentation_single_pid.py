...
origin_data_dir = '/udisk/data/train_200000'
...
class DataProcess(object):
    ...
    def __init__(self):
        ...
        self.json_path = '/data/data/crnn_train_data/json/meta.json'
        self.json_val_path = '/data/data/crnn_train_data/json/val.json'
    ...
    def data_preprocess(self):
        ...
        if not os.path.exists(self.image_path):
            print("train_data not exist, task over")
            return
        else:
            print("data(images&labels) already exists.")
        ...
        for root, dirs, files in os.walk(self.image_path):
            ...
            for file in files:
                ...
                try:
                    ...
                    print("warn: fail to read image: ", os.path.join(self.image_path, file))
                    continue
